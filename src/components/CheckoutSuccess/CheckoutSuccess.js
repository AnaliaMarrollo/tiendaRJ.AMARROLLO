...
const CheckoutSuccess = ({ orderId }) => {
    ...
    return (
        <div className="violet-container">
            ...
            <CustomButton textButton={"Volver al Inicio"} className="btn-login btn-container-violet" onClick={() => push("/")} />
            <CustomButton textButton={"Volver a comprar"} className="btn-login btn-container-violet" onClick={() => push("/nuestrosProductos")} />
        </div>
    )
}
