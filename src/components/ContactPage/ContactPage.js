...
const validationsForm = (form) => {
  ...
  if (!form.name.trim()) {
    ...
    errors.name =
      "El campo 'Nombre' solo acepta letras y debe contener mínimo 3 caracteres";
  }
  ...
  if (!form.surname.trim()) {
    ...
    errors.surname =
      "El campo 'Apellido' solo acepta letras y debe contener mínimo 3 caracteres";
  }
    ...
    <div className="contact-page-container">
      <div className="white-container-full">
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          />
          {errors.surname && (
            <p className="form-message form-message-error">{errors.surname}</p>
          )}
          ...
          />
          {errors.email && (
            <p className="form-message form-message-error">{errors.email}</p>
          )}
          ...
          />
          {errors.subject && (
            <p className="form-message form-message-error">{errors.subject}</p>
          )}
          ...
          <textarea
            ...
            className={
              errors.name
                ? "form-input form-input-errors"
                : "form-input form-input-comments"
            }
            name="comments"
            value={form.comments}
            cols="50"
          ...
          />
          {errors.comments && (
            <p className="form-message form-message-error">{errors.comments}</p>
          )}
          {errors && (
